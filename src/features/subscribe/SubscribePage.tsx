    ...
    <div className="mx-auto max-w-2xl space-y-8 pb-16">
      ...
      <div className="rounded-3xl bg-gradient-to-b from-brand-600 to-brand-800 px-6 py-10 text-center text-white shadow-xl">
        ...
        <h1 className="mt-3 text-3xl font-extrabold leading-tight sm:text-4xl">
          Your coaching and your posture app,<br />in one membership.
        </h1>
        <p className="mx-auto mt-3 max-w-lg text-white/85">
          Premium gives you the full coaching program and unlocks everything in PostureLab.
          Every problem named, every fix shown, and live weekly classes.
        </p>
        <div className="mt-6 flex items-baseline justify-center gap-2">
          <span className="text-4xl font-extrabold">${PRICE}</span>
          <span className="text-white/75">/month</span>
        </div>
        <p className="text-sm text-white/75">Only 90 cents a day. Cancel anytime.</p>
        <button
          onClick={goPro}
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {[
          ['🎯', 'Stop guessing', 'It names each problem and hands you the exact fix.'],
          ['📈', 'See it work', 'Scan weekly and watch your plumb line straighten and your number climb.'],
          ['🏆', 'Coaching too', 'Live weekly classes and new flows, all part of the membership.'],
        ].map(([icon, t, b]) => (
      ...
      <div className="rounded-3xl bg-slate-900 px-6 py-10 text-center text-white dark:bg-slate-800">
        ...
        <p className="mx-auto mt-2 max-w-md text-white/80">
          The full program and every fix, for only 90 cents a day.
        </p>
        <button
          onClick={goPro}
